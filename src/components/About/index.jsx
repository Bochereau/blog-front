...
const About = () => {
    ...
    const memberData = {
        name: "Boboch",
        avatar: Profil,
        journey: `Mon premier contact avec les jeux vidéo ne date pas d'hier, puisqu'il faut remonter au milieu des années 90. Un jour, chez des amis de mes parents, je me retrouve face à face avec une <strong>Megadrive</strong>. A l'intérieur du port cartouche : le jeu <strong>Sonic</strong>. Je passe alors l'après-midi à y jouer. Bien évidemment, je tanne mes parents pour avoir la même chose à la maison parce que "c'est vraiment trop cool".
...
Enfin, <strong>tout va changer en 2000</strong>, je suis desormais collégien et la <strong>Playstation</strong> est sur le marché depuis un moment, c'est un phénomène. A Noël, je reçois la version miniature de la mythique console : la PSOne. Elle sera accompagnée de Gran Turismo 2. Je suis aux anges !!! Et pourtant je n'arriverais jamais à m'investir dans ce jeu...

Un jour, alors que je jette un oeil aux jeux disponible dans un supermarché, l'un d'eux attire mon attention. La jaquette est sobre, épurée. Un fond blanc avec seulement un logo et un titre. A l'arrière on y voit des images dignent d'un film d'animation. On y lit : <strong>"Le voyage de votre vie"</strong>. Ce jeu c'est <strong>Final Fantasy VIII</strong>. Me voilà absorbé par cet univers, ces personnages et le destin qui les attends. Je finis le jeu quelques temps plus tard avec un ami et c'est la plus grande claque de ma vie. Pour le moment...

A la fin de cette même année, j'achête celui qui deviendra mon jeu préféré toutes consoles confondus. Celui qui me marquera à vie et qui laissera une trace indélébile dans mon coeur de joueur, <strong>l'intemporel Final Fantasy IX</strong>. C'est là, à cet instant, que les <strong>Final Fantasy</strong> et plus globalement les jeux vidéo vont occupé une place toute particulière dans ma vie.

Curieux d'en savoir plus sur cette série de jeux qui ne cesse de se réinventer, je dévore chaque épisode disponible sur la PSOne : Origins (1 et 2), Anthology (4 et 5), 6, 7 et même Tactics pour lequel je récupérerais une console pucée. Je commence aussi à m'intéresser aux autres jeux du même genre (Wild Arms, Grandia, Saga Frontier 2). Je deviens addict aux <strong>J-RPG</strong>. Voilà comment je suis tombé amoureux des jeux vidéos, de leurs univers, de leurs histoires, de leurs thématiques, du voyage qu'ils nous font vivre.`.trim(),
        top10Games: [
            "Final Fantasy IX",
            "Portal 2", 
            "Valkyrie Profile",
                    ...
                    <div className="member-presentation">
                        ...
                        <div className="member-info">
                            <div className="member-journey">
                                <p dangerouslySetInnerHTML={{ __html: memberData.journey.replace(/\n\n/g, '<br /><br />') }}></p>
                            </div>
                        </div>
                    </div>
