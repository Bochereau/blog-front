                ...
                <div className="about-content">
                    ...
                    <div className="about-content-profil">
                        ...
                        <div className="about-content-profil-description">
                            ...
                            <p>Un jour, chez des amis de mes parents, je me retrouve face à face avec une <em className="important">Megadrive</em>. A l'intérieur du port cartouche : le jeu <em className="important">Sonic</em>. Je passe alors l'après-midi à y jouer. Bien évidemment, je tanne mes parents pour avoir la même chose à la maison parce que <em className="important">"c'est vraiment trop cool"</em>. Nous sommes alors en <em className="important">1995</em>, j'ai 7 ans, et ils finissent par me dénicher une Megadrive en occasion avec quelques jeux dont :  <em className="important">Sonic 2</em>, <em className="important">Streets of Rage 2</em> ou encore <em className="important">Aladdin</em>.</p>
                            <p>Les <em className="important">premiers souvenirs</em> sont là :</p>
                            <ul>
                                <li>Apprendre les patterns de <em className="important">Metal Sonic</em>.</li>
                                <li><em className="important">Finir Streets of Rage 2</em> en coop avec mon père.</li>
                            </ul>
                            <p>Mais tout cela ne reste qu'un passe temps parmis d'autres...</p>
                            <p>Enfin, <em className="important">tout va changer en 2000</em>, je suis desormais collégien et la <em className="important">Playstation</em> est sur le marché depuis un moment, <em className="important">c'est un phénomène</em>. A Noël, je reçois la version miniature de la mythique console : la PSOne. Elle sera accompagnée de Gran Turismo 2. <em className="important">Je suis aux anges !!!</em> Et pourtant je n'arriverais jamais à m'investir dans ce jeu... </p>
                            <p>Oui oui nous y venons à celui qui à changé la donne.</p>
                            <p>Un jour, alors que je jette un oeil aux jeux disponible dans un supermarché, l'un d'eux attire mon attention. <em className="important">La jaquette est sobre, épurée</em>. Un fond blanc avec <em className="important">seulement un logo et un titre</em>. A l'arrière on y voit des images dignent d'un <em className="important">film d'animation</em>. On y lit : <em className="important">"Le voyage de votre vie"</em>.</p>
                            <p>Ce jeux c'est <em className="important">Final Fantasy VIII</em>.</p> 
                            <p>Me voilà absorbé par cet <em className="important">univers</em>, ces <em className="important">personnages</em> et le <em className="important">destin</em> qui les attends. Je finis le jeu quelques temps plus tard avec un ami et <em className="important">c'est la plus grande claque de ma vie</em>. Pour le moment...</p>
                            <p>A la fin de cette même année, j'achête <em className="important">celui qui deviendra mon jeu préféré</em> toutes consoles confondus. <em className="important">Celui qui me marquera à vie et qui laissera une trace indélébile dans mon coeur de joueur, l'intemporel Final Fantasy IX.</em></p>
                            <p>C'est là, à cet instant, que les Final Fantasy et plus globalement <em className="important">les jeux vidéo vont occupé une part importante de ma vie</em>. 
                            ...
                            <p>Enfin, je me suis ouvert à de nombreux autres genre de jeux avec toujours en tête cette <em className="important">envie d'être questionné sur des notions humanistes</em>.</p>
                            <p><em className="important">Voilà comment je suis tombé amoureux des jeux vidéos, de leurs univers, de leurs histoires, de leurs thématiques, du voyage qu'ils nous font vivre</em>.</p>
